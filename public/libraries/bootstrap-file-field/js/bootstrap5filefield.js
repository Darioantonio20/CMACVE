(function($){
    $.fn.bootstrap4FileField=function(options)
    {
        ...
        function __init($element,settings)
        {
            ...
            $element.css({opacity:0,width:0,height:0,position:'absolute',left:'-1000px'}).after('<div class="input-file-holder"><div class="input-file"><input type="text" readonly placeholder="'+placeholder+'" class="form-control float-start">'+button+'</div></div>');
